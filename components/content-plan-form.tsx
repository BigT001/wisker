  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      toast({
       ...
       // Use API key from form or localStorage as fallback
       const apiKey = formData.api_key || localStorage.getItem('openai_api_key') || undefined;
      
       // If API key is provided in the form, save it to localStorage for future use
       if (formData.api_key) {
         localStorage.setItem('openai_api_key', formData.api_key);
       }
       ...
       const config = {
         ...
         api_key: apiKey, // Add the API key if available
       };
       
       console.log("Sending content plan request with config:", {
         ...config,
         api_key: apiKey ? "[REDACTED]" : undefined, // Don't log the actual API key
       });
       ...
       toast({
         title: "Error",
         description: error instanceof Error ? error.message : "Failed to generate content plan. Please try again.",
         variant: "destructive",
       });
     } finally {
       setIsLoading(false);
    ...
    <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              {/* New fields for enhanced content generation */}
              <div className="space-y-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                <Label htmlFor="additional_characters">Additional Characters</Label>
                <Input
              ...
              <div className="space-y-2 sm:col-span-2">
                <Label htmlFor="api_key">OpenAI API Key (optional)</Label>
                <Input
                  id="api_key"
                  name="api_key"
                  type="password"
          ...
          {/* Fixed footer with proper padding and margin */}
          <CardFooter className="flex justify-end pt-4 px-6 pb-6">
            <Button
              type="submit"
              className="gap-2 bg-primary text-white bg-black "
      ...
      {contentPlan && (
        <Card className="mt-6">
          ...
          {/* Fixed footer with proper padding, margin and border */}
